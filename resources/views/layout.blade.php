        ...
        <nav class="mx-auto flex max-w-7xl items-center justify-between p-4 lg:px-6" aria-label="Global">
          ...
          <div class="hidden lg:flex lg:gap-x-12">
            <div class="relative">
              ...
              -->
              <div class="absolute opacity-0 top-full -left-8 z-10 mt-3 w-screen max-w-md overflow-hidden rounded-3xl bg-white ring-1 shadow-lg ring-gray-900/5">
                <div class="p-4">
            ...
            <a href="#" class="text-sm/6 font-semibold text-gray-900">Jelajahi</a>
