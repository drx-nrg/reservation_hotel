...
<nav class="fixed top-0 z-50 min-w-full bg-white border-b dark:bg-gray-800 dark:border-gray-700 flex justify-center">
      ...
      <div class="flex items-center justify-between">
        <div class="flex items-center justify-start rtl:justify-end">
          ...
          <a href="https://flowbite.com" class="flex ms-2 md:me-24">
            <span class="self-center text-xl font-bold whitespace-nowrap dark:text-white">Online<span
  ...
  <aside id="logo-sidebar" class="fixed top-0 left-0 z-40 w-64 h-screen pt-20 transition-transform -translate-x-64 bg-white border-r border-gray-200 dark:bg-gray-800 dark:border-gray-700" aria-label="Sidebar">
            ...
            <div class="md:flex md:justify-between">
                <div class="mb-6 md:mb-0">
                    <a href="https://flowbite.com/" class="flex items-center">
                        <span class="self-center text-2xl font-bold whitespace-nowrap dark:text-white">Online<span
                                class="text-blue-600">Reservation</span></span>
                    </a>
                </div>
