...
@section('main')
    <div class="container min-w-full min-h-screen flex justify-center">
                    ...
                    <ol class="inline-flex items-center space-x-1 md:space-x-2 rtl:space-x-reverse">
                        ...
                        <li>
                            <div class="flex items-center">
                                ...
                                <a href="#"
                                    class="ms-1 text-base font-medium text-gray-700 hover:text-blue-600 md:ms-2 dark:text-gray-400 ">Edit</a>
                            </div>
                        </li>
                    </ol>
                </nav>
        ...
        @endif
            ...
            <form class="w-full flex flex-col gap-3" action="{{route('rooms.update',$room['id'])}}"method='POST'>
                @csrf
                @method('PUT')
                <div class="form-group w-full flex flex-col gap-2 mt-3">
                    ...
                    <input value="{{$room['room_number']}}" type="text" name="room_number" placeholder="Masukkan nomor kamar" id="room_number" class="w-full rounded-md border border-slate-300 bg-white px-3 py-2.5 text-gray-700 shadow-xs transition focus:border-white focus:ring-3 focus:ring-blue-400 focus:shadow-sm focus:shadow-blue-200 focus:outline-hidden">
                </div>
                <div class="form-group w-full flex flex-col gap-2 mt-3">
                    <label for="room_type" class="font-semibold text-slate-600">Tipe Kamar</label>
                    <input value="{{$room['room_type']}}" type="text" name="room_type" placeholder="Masukkan tipe kamar" id="room_type" class="w-full rounded-md border border-slate-300 bg-white px-3 py-2.5 text-gray-700 shadow-xs transition focus:border-white focus:ring-3 focus:ring-blue-400 focus:shadow-sm focus:shadow-blue-200 focus:outline-hidden">
                </div>
                <div class="form-group w-full flex flex-col gap-2 mt-3">
                    <label for="price_per_night" class="font-semibold text-slate-600">Harga Per Malam</label>
                    <input value="{{$room['price_per_night']}}" type="text" name="price_per_night" placeholder="Masukkan harga per malam" id="price_per_night" class="w-full rounded-md border border-slate-300 bg-white px-3 py-2.5 text-gray-700 shadow-xs transition focus:border-white focus:ring-3 focus:ring-blue-400 focus:shadow-sm focus:shadow-blue-200 focus:outline-hidden">
                </div>
                <div class="form-group w-full flex flex-col gap-2 mt-3">
                    <label for="facilities" class="font-semibold text-slate-600">Fasilitas</label>
                    <input value="{{$room['facilities']}}" type="text" name="facilities" placeholder="Masukkan fasilitas" id="facilities" class="w-full rounded-md border border-slate-300 bg-white px-3 py-2.5 text-gray-700 shadow-xs transition focus:border-white focus:ring-3 focus:ring-blue-400 focus:shadow-sm focus:shadow-blue-200 focus:outline-hidden">
                </div>
                <div class="form-group w-full flex flex-col gap-2 mt-3">
                    <label for="status" class="font-semibold text-slate-600">Status</label>
                    <input value="{{$room['status']}}" type="text" name="status" placeholder="Masukkan status" id="status" class="w-full rounded-md border border-slate-300 bg-white px-3 py-2.5 text-gray-700 shadow-xs transition focus:border-white focus:ring-3 focus:ring-blue-400 focus:shadow-sm focus:shadow-blue-200 focus:outline-hidden">
                </div>
