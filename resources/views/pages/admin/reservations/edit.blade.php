        ...
        <div class="max-w-screen-xl w-full px-10 pt-20">
            ...
            <form class="w-full flex flex-col gap-3">
                <div class="form-group w-full flex flex-col gap-2 mt-3">
                    <label for="customer_id" class="font-semibold text-slate-600">Customer ID</label>
                    <select name="customer_id" id="customer_id" class="w-full rounded-md border border-slate-300 bg-white px-3 py-2.5 text-gray-700 shadow-xs transition focus:border-white focus:ring-3 focus:ring-blue-400 focus:shadow-sm focus:shadow-blue-200 focus:outline-hidden">
                        <option value="999">--- Pilih Customer ---</option>
                        <option value="999">Joko Widodo</option>
                    </select>
                </div>
                <div class="form-group w-full flex flex-col gap-2 mt-3">
                    <label for="name" class="font-semibold text-slate-600">Name</label>
                    <input type="text" name="name" placeholder="Masukkan Nama" id="name" class="w-full rounded-md border border-slate-300 bg-white px-3 py-2.5 text-gray-700 shadow-xs transition focus:border-white focus:ring-3 focus:ring-blue-400 focus:shadow-sm focus:shadow-blue-200 focus:outline-hidden">
                </div>
