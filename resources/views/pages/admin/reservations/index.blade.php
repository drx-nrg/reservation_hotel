    ...
    <div class="container min-w-full min-h-screen flex justify-center">
        <div class="max-w-screen-xl w-full px-10 pt-20">
            <div class="min-w-0 flex-1 flex flex-col items-start">
                ...
                <h2 class="text-2xl/7 font-bold text-gray-900 sm:truncate sm:text-3xl sm:tracking-tight">List Reservations
                </h2>
            </div>
                        ...
                        <tbody>
                            <tr>
                                ...
                                <td class="flex flex-row py-2">
                                    <a href="#" class="text-white bg-blue-700 hover:bg-blue-800 focus:outline-none focus:ring-4 focus:ring-blue-300 font-medium rounded-md text-sm px-4 py-2 text-center me-2 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800 flex items-center">Edit</a>
                                    <button type="button" class="text-white bg-red-700 hover:bg-red-800 focus:outline-none focus:ring-4 focus:ring-red-300 font-medium rounded-md text-sm px-4 py-2 text-center me-2 dark:bg-red-600 dark:hover:bg-red-700 dark:focus:ring-red-800 flex items-center">Delete</button>
                                </td>
                            </tr>
                        </tbody>
                    </table>
